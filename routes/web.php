...
Route::get('/managerole', [PageController::class, 'manageRolePage'])->name('managerole')->middleware('auth');
...
Route::get('/manageuser', [PageController::class, 'manageUserPage'])->name('manageuser')->middleware('auth');
...
Route::get('/manageform', [PageController::class, 'manageFormPage'])->name('manageform')->middleware('auth');
Route::get('/addform', [PageController::class, 'addFormPage'])->name('addform')->middleware('auth');
Route::get('/editform/{id}', [PageController::class, 'editFormPage'])->name('editform')->middleware('auth');
Route::get('/inputdata', [PageController::class, 'inputDataPage'])->name('inputdata')->middleware('auth');
Route::get('/approvedata', [PageController::class, 'approveDataPage'])->name('approvedata')->middleware('auth');
Route::get('/getform/{id}', [PageController::class, 'inputDataFormPage'])->middleware('auth');
Route::get('/profile', [PageController::class, 'profilePage'])->name('profile')->middleware('auth');
